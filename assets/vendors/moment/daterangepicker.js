...
! function (t, e) {
    ...
    var a = function (a, i, s) {
        if (this.parentEl = "body", this.element = e(a), this.startDate = t().startOf("day"), this.endDate = t().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = t().subtract(100, "year").format("YYYY"), this.maxYear = t().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
            ...
            var n, r, o, h = document.createElement("textarea");
        ...
        if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(":text")) {
            ...
            n = r = null, 2 == m.length ? (n = t(m[0], this.locale.format), r = t(m[1], this.locale.format)) : this.singleDatePicker && "" !== d && (n = t(d, this.locale.format), r = t(d, this.locale.format)), null !== n && null !== r && (this.setStartDate(n), this.setEndDate(r))
        }
        if ("object" == typeof i.ranges) {
            for (o in i.ranges) {
                n = "string" == typeof i.ranges[o][0] ? t(i.ranges[o][0], this.locale.format) : t(i.ranges[o][0]), r = "string" == typeof i.ranges[o][1] ? t(i.ranges[o][1], this.locale.format) : t(i.ranges[o][1]), this.minDate && n.isBefore(this.minDate) && (n = this.minDate.clone());
                var f = this.maxDate;
                if (this.maxSpan && f && n.clone().add(this.maxSpan).isAfter(f) && (f = n.clone().add(this.maxSpan)), f && r.isAfter(f) && (r = f.clone()), !(this.minDate && r.isBefore(this.minDate, this.timepicker ? "minute" : "day") || f && n.isAfter(f, this.timepicker ? "minute" : "day"))) {
    ...
    return a.prototype = {
        ...
        updateCalendars: function () {
            if (this.timePicker) {
                var t, e, a;
                if (this.endDate) {
                    if (t = parseInt(this.container.find(".left .hourselect").val(), 10), isNaN(e = parseInt(this.container.find(".left .minuteselect").val(), 10)) && (e = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)), a = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, !this.timePicker24Hour) {
                        var i = this.container.find(".left .ampmselect").val();
                        "PM" === i && t < 12 && (t += 12), "AM" === i && 12 === t && (t = 0)
                    }
                } else if (t = parseInt(this.container.find(".right .hourselect").val(), 10), isNaN(e = parseInt(this.container.find(".right .minuteselect").val(), 10)) && (e = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)), a = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, !this.timePicker24Hour) {
        ...
        renderCalendar: function (a) {
            var i, s, n = "left" == a ? this.leftCalendar : this.rightCalendar,
                r = n.month.month(),
                o = n.month.year(),
                h = n.month.hour(),
                l = n.month.minute(),
            ...
            Y += "<thead>", Y += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (Y += "<th></th>"), (!b || b.isBefore(n.firstDay)) && (!this.linkedCalendars || "left" == a) ? Y += '<th class="prev available"><span></span></th>' : Y += "<th></th>";
            var _ = this.locale.monthNames[n[1][1].month()] + n[1][1].format(" YYYY");
            if (this.showDropdowns) {
                for (var $ = n[1][1].month(), P = n[1][1].year(), w = C && C.year() || this.maxYear, x = b && b.year() || this.minYear, M = P == x, S = P == w, B = '<select class="monthselect">', I = 0; I < 12; I++)(!M || b && I >= b.month()) && (!S || C && I <= C.month()) ? B += "<option value='" + I + "'" + (I === $ ? " selected='selected'" : "") + ">" + this.locale.monthNames[I] + "</option>" : B += "<option value='" + I + "'" + (I === $ ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[I] + "</option>";
                B += "</select>";
                for (var L = '<select class="yearselect">', A = x; A <= w; A++) L += '<option value="' + A + '"' + (A === P ? ' selected="selected"' : "") + ">" + A + "</option>";
                L += "</select>", _ = B + L
            }
            if (Y += '<th colspan="5" class="month">' + _ + "</th>", (!C || C.isAfter(n.lastDay)) && (!this.linkedCalendars || "right" == a || this.singleDatePicker) ? Y += '<th class="next available"><span></span></th>' : Y += "<th></th>", Y += "</tr>", Y += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (Y += '<th class="week">' + this.locale.weekLabel + "</th>"), e.each(this.locale.daysOfWeek, function (t, e) {
                    Y += "<th>" + e + "</th>"
            ...
            for (var s = 0; s < 6; s++) {
                ...
                for (var i = 0; i < 7; i++) {
                    var O = [];
                    n[s][i].isSame(new Date, "day") && O.push("today"), n[s][i].isoWeekday() > 5 && O.push("weekend"), n[s][i].month() != n[1][1].month() && O.push("off", "ends"), this.minDate && n[s][i].isBefore(this.minDate, "day") && O.push("off", "disabled"), C && n[s][i].isAfter(C, "day") && O.push("off", "disabled"), this.isInvalidDate(n[s][i]) && O.push("off", "disabled"), n[s][i].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && O.push("active", "start-date"), null != this.endDate && n[s][i].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && O.push("active", "end-date"), null != this.endDate && n[s][i] > this.startDate && n[s][i] < this.endDate && O.push("in-range");
                    var W = this.isCustomDate(n[s][i]);
                    !1 !== W && ("string" == typeof W ? O.push(W) : Array.prototype.push.apply(O, W));
                    for (var H = "", N = !1, y = 0; y < O.length; y++) H += O[y] + " ", "disabled" == O[y] && (N = !0);
                    N || (H += "available"), Y += '<td class="' + H.replace(/^\s+|\s+$/g, "") + '" data-title="r' + s + "c" + i + '">' + n[s][i].date() + "</td>"
                }
                Y += "</tr>"
            }
            ...
            if ("right" != t || this.endDate) {
                ...
                for (var l = 0; l < 60; l += this.timePickerIncrement) {
                    var f = l < 10 ? "0" + l : l,
                        d = a.clone().minute(l),
                        m = !1;
                    i && d.second(59).isBefore(i) && (m = !0), s && d.second(0).isAfter(s) && (m = !0), a.minute() != l || m ? m ? e += '<option value="' + l + '" disabled="disabled" class="disabled">' + f + "</option>" : e += '<option value="' + l + '">' + f + "</option>" : e += '<option value="' + l + '" selected="selected">' + f + "</option>"
                }
        ...
        move: function () {
            ...
            if (this.container.toggleClass("drop-up", "up" == i), "left" == this.opens) {
                ...
                var o = this.element.offset().left - a.left + this.element.outerWidth() / 2 - n / 2;
            ...
            if (e(t.target).hasClass("available")) {
                ...
                if (this.endDate || n.isBefore(this.startDate, "day")) {
                    ...
                    if (this.timePicker) {
                        ...
                        var l = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0;
                        n = n.clone().hour(r).minute(h).second(l)
                    }

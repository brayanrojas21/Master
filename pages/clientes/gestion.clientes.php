                            ...
                            <div class="card-body">
                                <div class="product-nav-wrapper row">
                                    <div class="col-lg-6 col-md-5">
                                        ...
                                        <p>Aquí puedes ver tus clientes registrados ya sean activos o inactivos</p>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="clientes" class="table dt-responsive nowrap table-sm w-100 table-hover table-bordered">
    ...
    <div class="modal-dialog modal-lg modal-fullscreen-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="exampleModalLabel">Gestionar cliente</h2>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-7 col-md-12">
                                <div class="detalles p-3">
                                    <h4 class="text-center mb-5">Detalle de la empresa y encargado</h4>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="nit_empresa">Nit empresa/Cedula</label>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="cedula_encargado">Cédula encargado</label>
                                                <input type="text" class="form-control" id="cedula_encargado" name="cedula_encargado">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="telefono_encargado">Telefono/Celular encargado</label>
                                                <input type="text" class="form-control" id="telefono_encargado" name="telefono_encargado">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="telefono_encargado">Telefono secundario encargado</label>
                                                <input type="text" class="form-control" id="telefono2_encargado" name="telefono2_encargado">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="cargo_encargado">Cargo encargado</label>
                                                <input type="text" class="form-control" id="cargo_encargado" name="cargo_encargado">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-12 border">
                                <div class="informacion p-3">
                                    ...
                                    <div class="form-group">
                                        <label for="telefono_representante">Telefono/Celular representante</label>
                                        <input type="text" class="form-control" id="telefono_representante" name="telefono_representante">
                                    </div>
                                    <div class="form-group">
                                        <label for="correo_representante">Correo representante</label>
                                        <input type="text" class="form-control" id="correo_representante" name="correo_representante">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="servicios_aprobados">Servicios para clientes</label>
                                        <select class="multiple form-control text-dark" id="servicios_aprobados" data-style="form-control-lg" name="servicios_aprobados[]" multiple>
...
<script defer src="./assets/js/logica/clientes/gestion.clientes.js?v<?=uniqid();?>"></script>
